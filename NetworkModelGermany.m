...
function  [frac_AP,CustomersPerFeeder,PeakLoad,CustomersPerTransformer,TransformerType...
...
if PopDensity <= 8270
    frac_AP_old = min([0.1812*log(0.0297*PopDensity+3.6815) 1]);
...
n0 = ceil(PeakLoadTR/TransformerCap(1));
